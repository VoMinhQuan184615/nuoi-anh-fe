...
import { Button } from "@/features/login/shared/button";
import {
  Card,
  CardContent,
  CardDescription,
  CardHeader,
  CardTitle,
} from "@/features/login/shared/card";
import { Input } from "@/features/login/shared/input";
import { Label } from "@/features/login/shared/label";
import loginImage from "../../../assets/login-images.png";
            ...
            <form onSubmit={handleSubmit}>
              <div className="grid gap-6">
                <div className="flex flex-col gap-4 ">
                  <Button
                    variant="outline"
                    className="w-full bg-white/70 border-white/30"
                  >
